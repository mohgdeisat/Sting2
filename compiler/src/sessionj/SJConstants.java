...
public class SJConstants
{
	...
	public static final String SJ_KEYWORD_NOALIAS = "noalias";
        //<By MQ>
        public static final String SJ_KEYWORD_PROTOCOL = "lprotocol"; //Updated "protocol" to "lprotocol"
        public static final String SJ_KEYWORD_GPROTOCOL = "protocol"; //Added the gprotocol keyword
        public static final String SJ_KEYWORD_PARTICIPANTS = "participants"; //Added the gprotocol keyword
	...
	public static final String SJ_STRING_SEPARATOR = ".";
        public static final String SJ_STRING_CBEGIN = "!begin";     //<By MQ> Modified to reflect change of cbegin to begin
        public static final String SJ_STRING_SBEGIN = "?begin";    //<By MQ>
    ...
    //<By MQ> For our newly defined nodes
    public static final String SJ_STRING_PARTICIPANTS = "participants";
    ...
    //<By MQ> Added for our newly defined types
    public static final String SJ_STRING_GPROTOCOL_DUAL_PREFIX = "^";
    public static final String SJ_STRING_GPROTOCOL_REF_PREFIX = "@";
    //</By MQ>
    ...
    //<By MQ> Our newly defined types
    public static Type SJ_GPROTOCOL_TYPE;
    //</By MQ>
    ...
    //<By MQ> Our newly defined types
        public static final String SJ_GPROTOCOL_CLASS = "sessionj.runtime.SJGProtocol";
    //</By MQ>
